...
function gcpc_response_columns($defaults) {
    $defaults['comp_num'] = 'Competency Number';
    $defaults['task_num'] = 'Scenario ID';
    $defaults['sub_num'] = 'Participant ID';
...
add_filter('manage_response_posts_columns','gcpc_response_columns');
...
add_action('manage_response_posts_custom_column','gcpc_populate_columns', 10, 2);